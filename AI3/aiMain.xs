...
{
   if ((cMyCiv == cCivzGalacticEmpire) || (cMyCiv == cCivzGalacticEmpire1) || (cMyCiv == cCivzGalacticEmpire2) || (cMyCiv == cCivzGalacticEmpire3))
      return(true);
...
minInterval 5
{
   if (kbGetAge() >= cAge2)   // We're in age 2
   {
      ...
      xsEnableRule("empireAge2UpgradeMonitor");
...
minInterval 10
{
   if (kbGetAge() >= cAge3)
   {
      ...
      xsEnableRule("empireAge3UpgradeMonitor");
      gAgeUpTime = xsGetTime();
      xsDisableSelf();
...
void initEcon(void)
{
   ...
   if ( (kbGetCiv() == cCivzGalacticEmpire) || (kbGetCiv() == cCivzGalacticEmpire1) || (kbGetCiv() == cCivzGalacticEmpire2) || (kbGetCiv() == cCivzGalacticEmpire3) )
   {
      gEconUnit = cUnitTypezLaborDroid;
      gHouseUnit = cUnitTypezPrefabShelterEmpire;
      gTowerUnit = cUnitTypezTurretEmpire;
   }
...
{ 
  ...
  if ( (kbGetCiv() == cCivChinese) || (kbGetCiv() == cCivSPCChinese) ) {
    ...
    if (civIsEmpire()==true) {    
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezStormtrooper, 0.8);   // Range 0.0 to 1.0
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezScoutTrooper, 0.6);   // Range 0.0 to 1.0
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezRiotTrooper, 0.5);   // Range 0.0 to 1.0
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezDemolitionTrooper, 0.4);   // Range 0.0 to 1.0
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezBikerScout, 0.5);   // Range 0.0 to 1.0
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezTIEMauler, 0.4);
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezTX225Tank, 0.4);
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezATDP, 0.5);
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezTIELN, 0.7);
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezTIEBomber, 0.5);
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypezTIEInterceptor, 0.5);
        
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractArtillery, 0.0);
    kbUnitPickSetPreferenceFactor(gLandUnitPicker, cUnitTypeAbstractSepoy, 0.4); //Is abstractStarfighter, Fighters will need either an AbstractCavalry or AbstractArtillery
  }
...
//Give Economic Guild to Factions, if Headquarters are already built, first need to change zPrefabShelterEmpire to zHeadquarters, and population count is good
  
  if ( (civIsEmpire() == true) && (kbUnitCount(cMyID, cUnitTypezPrefabShelterEmpire, cUnitStateABQ) < 1))
   {
      planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezEconomicGuild);
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezEconomicGuild, cUnitStateAlive) < 1) )
      { 
         createSimpleBuildPlan(cUnitTypezEconomicGuild, 1, 60, true, cEconomyEscrowID, kbBaseGetMainID(cMyID), 1);
         aiEcho("Starting a economic guild build plan.");
      }   
   }
   
//If Headquarters are built, population count is good, and I can afford, I should build barracks
  
  if ( (civIsEmpire() == true) && (kbUnitCount(cMyID, cUnitTypezPrefabShelterEmpire, cUnitStateABQ) < 2))
   {
   ...
   // ***************************************************
	...
	if ( (civIsAsian() == true) || (civIsNative() == true) || (civIsEmpire() == true) )
	{
		...
		{     // Start a new one
			createSimpleBuildPlan(cUnitTypeTownCenter, 1, 80, false, cMilitaryEscrowID, kbBaseGetMainID(cMyID), 1);
			aiEcho("Maintain Town Center plan.");
		}   
	}
   ...
   if ( (civIsNative() == false) && (civIsAsian() == false) && (civIsEmpire() == false) )
   {
   ...
   if (civIsEmpire() == true)
   {
      ...
      planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezLightFactory); //At least one Light Factory
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezLightFactory, cUnitStateAlive) < 1) )
      {
         createSimpleBuildPlan(cUnitTypezLightFactory, 1, 70, false, cMilitaryEscrowID, kbBaseGetMainID(cMyID), 1);
   ...
   if (civIsEmpire() == true)
   {
      ...
      planID = aiPlanGetIDByTypeAndVariableType(cPlanBuild, cBuildPlanBuildingTypeID, cUnitTypezLightFactory); //One more light vehicle factory
      if ( (planID < 0) && (kbUnitCount(cMyID, cUnitTypezLightFactory, cUnitStateAlive) < 2) )
      {
         createSimpleBuildPlan(cUnitTypezLightFactory, 1, 50, false, cMilitaryEscrowID, kbBaseGetMainID(cMyID), 1);
         aiEcho("Starting a LVF build plan.");
      }
   }
...
rule empireAge2UpgradeMonitor
inactive
minInterval 90
{
   int upgradePlanID = -1;

   // Disable rule for non-Imperial Civs
   if (civIsEmpire() == false)
   {
      xsDisableSelf();
      return;
   }
   ...
   // Infantry Barracks units
   if ((kbTechGetStatus(cTechzUpgradeImperialHeavyTroopers) == cTechStatusObtainable) && (kbUnitCount(cMyID, cUnitTypezRiotTrooper, cUnitStateAlive) >= 12))
   {
      upgradePlanID = aiPlanGetIDByTypeAndVariableType(cPlanResearch, cResearchPlanTechID, cTechzUpgradeImperialHeavyTroopers);
      if (upgradePlanID >= 0)
         aiPlanDestroy(upgradePlanID);
      createSimpleResearchPlan(cTechzUpgradeImperialHeavyTroopers, getUnit(cUnitTypezInfantryBarracks), cMilitaryEscrowID, 50);
      return;
   }
   if (kbTechGetStatus(cTechzMouseDroids) == cTechStatusObtainable) //Research Mouse Droids at Town Center
   {
      upgradePlanID = aiPlanGetIDByTypeAndVariableType(cPlanResearch, cResearchPlanTechID, cTechzMouseDroids);
      if (upgradePlanID >= 0)
         aiPlanDestroy(upgradePlanID);
      createSimpleResearchPlan(cTechzMouseDroids, getUnit(cUnitTypeTownCenter), cMilitaryEscrowID, 50);
      return;
   }
   if (kbTechGetStatus(cTechzBasicTraining) == cTechStatusObtainable) //Research Basic Training at Town Center
   {
      upgradePlanID = aiPlanGetIDByTypeAndVariableType(cPlanResearch, cResearchPlanTechID, cTechzBasicTraining);
      if (upgradePlanID >= 0)
         aiPlanDestroy(upgradePlanID);
      createSimpleResearchPlan(cTechzBasicTraining, getUnit(cUnitTypeTownCenter), cMilitaryEscrowID, 50);
      return;
   }
}


rule empireAge3UpgradeMonitor
inactive
minInterval 90
{
   int upgradePlanID = -1;
   ...
   // Infantry Barracks units
   if ((kbTechGetStatus(cTechzPrivateStormtroopers) == cTechStatusObtainable) && (kbUnitCount(cMyID, cUnitTypezStormtrooper, cUnitStateAlive) >= 12))
   {
      upgradePlanID = aiPlanGetIDByTypeAndVariableType(cPlanResearch, cResearchPlanTechID, cTechzPrivateStormtroopers);
      if (upgradePlanID >= 0)
         aiPlanDestroy(upgradePlanID);
      createSimpleResearchPlan(cTechzPrivateStormtroopers, getUnit(cUnitTypezInfantryBarracks), cMilitaryEscrowID, 50);
      return;
   }
   if (kbTechGetStatus(cTechzSensorBeacon) == cTechStatusObtainable) //Research Sensor Beacon at Town Center
   {
      upgradePlanID = aiPlanGetIDByTypeAndVariableType(cPlanResearch, cResearchPlanTechID, cTechzSensorBeacon);
      if (upgradePlanID >= 0)
         aiPlanDestroy(upgradePlanID);
      createSimpleResearchPlan(cTechzSensorBeacon, getUnit(cUnitTypeTownCenter), cMilitaryEscrowID, 50);
      return;
   }
}
